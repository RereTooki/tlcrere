    ...
    <>
      ...
      <div className="font-proxima flex flex-col items-center">
        <div className="md:flex md:flex-row gap-x-[1.59vw]  mx-[6.8vw] md:fle-wrap md:mb-[5.3vw]">
          <div className="rounded-[1.8vw] flex flex-col items-center pt-[14.5vw] md:py-[4.4vw] pb-[11.5vw] bg-oransgee shadow-[0_2px_8px_0_rgba(0,0,0,0.1)] md:shadow-[0_6.5px_26px_0_rgba(0,0,0,0.1)] mt-[28.1vw] md:mt-[10vw]">
            <div className="w-[23.5vw] md:w-[7.2vw] h-[19.9vw] md:h-[6.1vw] mb-[5.4vw] md:mb-[1.6vw]">
              <img
          ...
          <div className="bg-light-sgrey rounded-[1.8vw] flex flex-col items-center pt-[14.5vw] md:py-[4.4vw] pb-[11.5vw] shadow-[0_2px_8px_0_rgba(0,0,0,0.1)] md:shadow-[0_6.5px_26px_0_rgba(0,0,0,0.1)] mt-[28.1vw] md:mt-[10vw]">
            <div className="w-[23.5vw] md:w-[7.2vw] h-[19.9vw] md:h-[6.1vw] mb-[5.4vw] md:mb-[1.6vw]">
              <img
                className="w-[23.5vw] md:w-[7.2vw] h-[19.9vw] md:h-[6.1vw]"
                src={logo2}
          ...
          <div className="bg-mediusm-grey rounded-[1.8vw] flex flex-col items-center pt-[14.5vw] md:py-[4.4vw] pb-[11.5vw] bg-sorangee shadow-[0_2px_8px_0_rgba(0,0,0,0.1)] md:shadow-[0_6.5px_26px_0_rgba(0,0,0,0.1)] my-[28.1vw] md:my-0 md:mt-[10vw]">
            <div className="w-[23.5vw] md:w-[7.2vw] h-[19.9vw] md:h-[6.1vw] mb-[5.4vw] md:mb-[1.6vw]">
              <img
                className="w-[23.5vw] md:w-[7.2vw] h-[19.9vw] md:h-[6.1vw]"
                src={logo3}
