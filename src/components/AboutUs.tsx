    ...
    <>
      <div className="md:flex md:flex-row md:ml-[5.4vw] md:mr-[5.6vw]">
        <div className="md:mt-[11vw]">
          ...
          <div className="font-roboto leading-[7.2vw] md:leading-[4.1vw] text-[4.5vw] md:text-[1.8vw] mt-[12.5vw] md:mt-[3vw] ml-[8.6vw] mr-[8vw] md:mx-0 md:pb-0 mb-[27.5vw] md:mb-0 text-dark-black">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="z-20">
            <div className="ml-[17.2vw] h-[63.4vw] md:h-[21.8vw] w-[72.5vw] md:w-[34vw] md:rounded-[1.8vw]">
              <img
                className="grayscale h-[63.4vw] md:h-[21.8vw] w-[72.5vw] md:w-[34vw] md:rounded-[1.8vw]"
                src={rect}
                alt="First rectangle"
              />
            </div>
          ...
          <div className="md:flex md:flex-row">
            <div className="relative mr-[18vw] ml-[9.9vw] md:mr-0 md:ml-[100px] bottom-[9.9vw] md:top-[4.4vw] bg-slate-700 h-[71.4vw] md:h-[21.8vw] w-[74.3vw] md:w-[24vw] md:rounded-[1.8vw] z-30">
              <img
                className="grayscale h-[71.4vw] md:h-[21.8vw] w-[74.3vw] md:w-[24vw] md:rounded-[1.8vw]"
                src={rect2}
        ...
        <div className="md:flex md:flex-col-reverse">
          <div className="flex flex-col items-center md:items-end relative md:mb-0">
            ...
            <div className="absolute mr-[9.2vw] md:mr-[5.5vw] top-[11.3vw] md:top-[2.6vw] bg-slate-700 h-[68.7vw] md:h-[26.5vw] w-[89.5vw] md:w-[52.3vw] md:rounded-[1.8vw]">
              <img
                className="grayscale h-[68.7vw] md:h-[26.5vw] w-[89.5vw] md:w-[52.3vw] md:rounded-[1.8vw]"
                src={rect4}
                alt="My 4th rectangle"
              />
            </div>
          </div>
          <div className="md:text-[1.8vw] text-[4.5vw] text-dark-black font-roboto leading-[7.2vw] md:leading-[4.1vw] ml-[6.1vw] md:ml-[8.8vw] mr-[6.1vw] md:mr-[5.6vw] md:mt-[9vw] pb-[24.15px] md:pb-0 mb-[24.9vw] md:mb-[11vw] mt-[38.2vw] ">
            Great software that allows you to chat from any place at any time
            without any interruption! Great software that allows you to chat
            from any place at any time without any interruption!
          </div>
